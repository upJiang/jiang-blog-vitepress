...
<InfraFigure src="/images/ai-infra/linux-service-troubleshooting/hero.png" alt="Linux 服务从启动、读取配置、绑定端口到接收请求的技术插画"
  icon="terminal" caption="服务可用之前，进程必须依次跨过文件、权限、端口和资源边界。" />
