...
<InfraFigure src="/images/ai-infra/network-dns-tls-http-proxy/hero.png" alt="客户端请求穿过域名解析、加密连接、反向代理和源站的技术插画"
  icon="network" caption="浏览器里的一条 URL，会依次触发解析、连接、握手和两段 HTTP 传输。" />
