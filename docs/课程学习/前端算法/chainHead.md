...
示例：<br> 给定一个链表: 1->2->3->4->5->null, 和 n = 2. <br> 当删除了倒数第二个结点后，链表变为 1->2->3->5->null. <br>
...
- 当 fast 指针走到底了 !fast.next，那么 slow 此时的位置就是题目中倒数第 n -1 的位置，此时改变 slow 的 next： slow.next = slow.next.next
...
**处理链表的本质，是处理链表结点之间的指针关系。** <a data-fancybox title="img" href="https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2020/3/29/171260bdb3250b83~tplv-t2oaga2asx-watermark.awebp">![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2020/3/29/171260bdb3250b83~tplv-t2oaga2asx-watermark.awebp)</a>
