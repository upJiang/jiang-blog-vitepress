...
选择一个广告组，逐项写出用户搜索词、广告承诺、落地页首屏、主要行动和后端业务结果。五项应围绕同一任务。例如搜索“预约软件价格”，广告承诺查看套餐，落地页却只讲品牌故事，点击率再高也难形成有效试用。
...
| 创意 | 主题、差异、限制和清晰行动 |
| 落地页 | 首屏兑现承诺，价格/条件可核对 |
| 主要转化 | 表单或激活真正成功，不是按钮点击 |
| 业务结果 | 有效线索、成交、毛利与退款 |

追踪事件使用不含邮箱、电话和姓名的业务身份，重复提交由幂等键返回同一结果。必要同意未取得时，不加载非必要分析和广告追踪；业务表单仍按合法目的工作。平台转化要与后端记录对账，并把退款或无效线索按规则修正。

验收覆盖桌面/移动、成功/失败、重复提交、后端超时、拒绝分析同意和广告参数跨页保留。任何追踪代码回滚都不能破坏表单本身。创意实验一次改变清楚的变量，观察搜索词质量、页面行为和业务结果，不以 CTR 单项决定胜负。
