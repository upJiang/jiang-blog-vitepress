...
const removedRoutes = [
  ...
  '/docs/ai-agent/document-parsing-block-chunking',
  '/docs/ai-agent/knowledge-graph-wiki-alias',
  '/docs/ai-agent/pgvector-index-recall',
  '/docs/ai-agent/rag-ingestion-pipeline',
  '/docs/ai-practice/ai-capability-concepts',
  '/docs/ai-practice/ai-coding-development-loop',
  ...
  '/docs/ai-practice/skill-design-workflow-mining',
  '/docs/ai-practice/subagent-development-workflows',
