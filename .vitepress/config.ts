...
export default{
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: '📚前端知识点', link: '/docs/jsBase/git' },
    ...
    sidebar: {
      ...
      '/docs/jsBase/': [
            { text: '知识结构', link: '/docs/jsBase/start' },
            { 
              text: '面试', 
              collapsed: true,
              items: [
                { text: '面试指南', link: '/docs/jsBase/interview/target' },
                { text: '22年初面试准备', link: '/docs/jsBase/interview/22Ready' },
                { text: '手写面试题', link: '/docs/jsBase/interview/writeQuestion' },
                { text: 'js问题', link: '/docs/jsBase/interview/jsBaseQuestion' },
                { text: 'vue问题', link: '/docs/jsBase/interview/vueBaseQuestion' },
                { text: 'react问题', link: '/docs/jsBase/interview/reactBaseQuestion' },
                {
                  text: '计算机网络问题',
                  link: '/docs/jsBase/interview/networkBaseQuestion'
                },
                { text: '垂直居中', link: '/docs/jsBase/interview/center' },
                { text: '进程、线程', link: '/docs/jsBase/interview/process' },
                { text: '判断数据类型', link: '/docs/jsBase/interview/dataType' },
                { text: '盒模型及如何转换', link: '/docs/jsBase/interview/boxsizing' },
                { text: '回流、重绘', link: '/docs/jsBase/interview/repaint' },
                { text: '节流防抖', link: '/docs/jsBase/interview/debounce' },
                { text: 'HTTP状态码', link: '/docs/jsBase/interview/httpCode' },
                {
                  text: 'vue中的hash跟history',
                  link: '/docs/jsBase/interview/hashMode'
                },
                {
                  text: 'promise链式无限回调',
                  link: '/docs/jsBase/interview/promiseCicle'
                },
                { text: 'async', link: '/docs/jsBase/interview/async' },
                {
                  text: 'proxy/defineProperty',
                  link: '/docs/jsBase/interview/defineProperty'
                },
                { text: 'dns域名解析做了什么', link: '/docs/jsBase/interview/dns' },
                { text: '长列表的优化', link: '/docs/jsBase/interview/longList' },
                { text: '输入URL', link: '/docs/jsBase/interview/URL' },
                { text: 'css', link: '/docs/jsBase/interview/css' }
              ] 
            },
            { 
              text: '进阶',
              ...
              items:[
                {
                  text: 'chatGPT微信机器人搭建',
                  link: '/docs/jsBase/jsAdvanced/chatGPT'
                },
                { text: 'TS', link: '/docs/jsBase/jsAdvanced/ts' },
                { text: 'vue3', link: '/docs/jsBase/jsAdvanced/vue3' },
                { text: 'vite', link: '/docs/jsBase/jsAdvanced/vite' },
                { text: '纯函数', link: '/docs/jsBase/jsAdvanced/pureFuntion' },
                { text: 'nvm管理node', link: '/docs/jsBase/jsAdvanced/nvm' },
                { text: 'cURL', link: '/docs/jsBase/jsAdvanced/cURL' },
                { text: 'husky', link: '/docs/jsBase/jsAdvanced/husky' },
                { text: 'js原理学习路线', link: '/docs/jsBase/jsAdvanced/jsAdvanced' },
                { text: 'sentry', link: '/docs/jsBase/jsAdvanced/sentry' },
                {
                  text: 'vue3的三种组件封装',
                  link: '/docs/jsBase/jsAdvanced/vueComponent'
                },
                { text: 'mock', link: '/docs/jsBase/jsAdvanced/mock' },
                { text: '组件库开发', link: '/docs/jsBase/jsAdvanced/jiangVui' },
                {
                  text: '请求loading封装',
                  link: '/docs/jsBase/jsAdvanced/loadingHandle'
                },
                {
                  text: '前端规范',
                  link: '/docs/jsBase/jsAdvanced/standard'
                },
                {
                  text: 'changelog',
                  link: '/docs/jsBase/jsAdvanced/changelog'
                },
                {
                  text: '监控与埋点',
                  link: '/docs/jsBase/jsAdvanced/monitor'
                },
                {
                  text: 'gulp',
                  link: '/docs/jsBase/jsAdvanced/gulp'
                },
                {
                  text: '性能优化',
                  link: '/docs/jsBase/jsAdvanced/performance'
                },
                {
                  text: '服务器搭建',
                  link: '/docs/jsBase/jsAdvanced/server'
                }
              ]
            },
      ...
      '/docs/babel/': [
        {
          text: 'babel 通关秘籍',
          items: [{ text: '介绍', link: '/docs/babel/start' }]
        }
      ],
      '/docs/howReview/': [
        {
